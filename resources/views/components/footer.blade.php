<!-- ========== FOOTER ========== -->
<footer class="w-full mt-auto bg-white dark:bg-neutral-950">
    <div class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        <!-- Grid -->
        <div class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-3">
            <div class="col-span-full lg:col-span-1">
                <a class="flex-none text-xl font-semibold text-gray-800 dark:text-white focus:outline-hidden focus:opacity-80" href="#"
                    aria-label="Brand">Brand</a>
                <div class="my-5 text-gray-600 dark:text-gray-500 ">
            ...
            <div class="grid col-span-1 gap-5">
                <div>
                    <h4 class="font-semibold dark:text-gray-100">Shipping Method</h4>
                ...
                <div>
                    <h4 class="font-semibold dark:text-gray-100">Payment Method</h4>
                    <div class="flex flex-wrap gap-2 mt-3">
                        <div class="flex items-center px-2 bg-white">
            ...
            <div class="col-span-1">
                <h4 class="font-semibold dark:text-gray-100">Help</h4>
