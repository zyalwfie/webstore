												...
												<div class="mt-2 grid grid-cols-2 gap-3">
															<div class="col-span-2">
																		<input
																					...
																					id="af-payment-billing-contact" placeholder="Full Name" type="text" wire:model='data.full_name'>
															...
															<div>
																		<input
																					...
																					placeholder="Phone Number" type="text" wire:model='data.phone'>
																		@error('data.phone')
																					<p class="mt-2 text-xs text-red-600" id="hs-validation-name-error-helper">
																								{{ $message }}</p>
																		@enderror
									...
									<div
												...
												<div class="mt-2 space-y-3">
															<input
																		...
																		id="af-payment-billing-address" placeholder="Street Address" type="text"
