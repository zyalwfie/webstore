<div class="container mx-auto max-w-[85rem] w-full px-4 sm:px-6 lg:px-8 py-10">
    <div class="grid grid-cols-1 gap-10 md:grid-cols-10">
        <div class="grid grid-cols-1 gap-10 pr-6 border-r border-gray-200 md:col-span-3">
            <div>
                <div class="space-y-1">
                    <input type="text" placeholder="Cari produk..." wire:model='search'
                ...
                <div class="grid grid-cols-2 mt-10">
                    <button type="button" wire:click='applyFilters' wire:loading.attr='disabled'
                        ...
                        Terapkan Filter
                        <div wire:loading wire:target='applyFilters' class="animate-spin inline-block size-4 border-3 border-current border-t-transparent text-white rounded-full"
        ...
        <div class="col-span-1 md:col-span-7">
            <div class="flex items-center justify-between gap-5">
                <div class="font-light text-gray-800">Menampilkan {{ $products ? $products->total() : 0 }} produk</div>
